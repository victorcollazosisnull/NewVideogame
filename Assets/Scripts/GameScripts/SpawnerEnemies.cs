    ...
    private IEnumerator SpawnGhosts()
    {
        ...
        switch (currentGameMode)
        {
            case GameMode.Easy:
                gameTime = 120f;
                spawnTime = 2f;
                enemiesToSpawn = 29; // Solo enemigos grandes(puede variar)
                break;
            case GameMode.Normal:
                gameTime = 90f;
                spawnTime = 1f;
                maxGhostsToCatch = 40;
                enemiesToSpawn =39; // 50 grandes y 50 pequeños(puede variar)
                break;
            case GameMode.Hard:
                gameTime = 60f;
                spawnTime = 0.5f;
                maxGhostsToCatch = 90;
                enemiesToSpawn = 89; // 100 grandes y 100 pequeños(puede variar)
                break;
        }
